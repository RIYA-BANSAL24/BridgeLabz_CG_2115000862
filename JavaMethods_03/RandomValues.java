...
public class RandomValues{
	public static int[] generateFourDigit(int size) {
	...
	public static void main(String[] args) {
       		int size =6;
       		int[] randomNumbers = generateFourDigit(size);
       		System.out.println("Generated Four-digit random numbers: " + Arrays.toString(randomNumbers));
